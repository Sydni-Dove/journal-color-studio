...
export const DECORATION_CAPABILITIES: Record<string, DecorationCapability[]> = {
  ...
  "jcs-floral-bouquet": ["title-rule-right", "title-rule-left", "title-rule-center", "footer-flourish", "top-bottom"],
  "jcs-floral-corner": ["corner-contained", "corner-bleed"],
  "jcs-floral-sprig": ["title-rule-right", "title-rule-left", "title-rule-center", "title-left", "title-right"],
