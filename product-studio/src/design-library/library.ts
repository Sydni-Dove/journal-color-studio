...
import floralBouquet from "./assets/floral-cover.jpg?url";
 ...
 */
export type MarbleAsset = Base & { type: "marble"; shadeBase: number; shadeAmt: number };
...
const snap = { source: JCS_SNAPSHOT.source, version: 1 } as const;
const BACKGROUND: DecorativePlacement[] = ["full-page", "header-band", "border-frame"];
const ACCENT: DecorativePlacement[] = ["corners", "full-page", "header-band"];
...
export const DESIGN_ASSETS: DesignAsset[] = [
  ...
  // Floral artwork.
  { ...snap, type: "floral", usage: "bouquet", id: "jcs-floral-bouquet", label: "Floral bouquet", sourceFile: "floral-cover.jpg", sha1: "d46b66a5d0fe4070b7e864a116c1f9c1475b714b", url: floralBouquet, size: { w: 2666, h: 3416 }, placements: ["full-page", "header-band", "border-frame"] },
  ...
  { ...snap, type: "floral", usage: "sprig", id: "jcs-floral-sprig", label: "Floral header sprigs", sourceFile: "floral-header.png", sha1: "368b2f4921410c7bcecd7d313d5450e406c9a095", url: floralSprig, size: { w: 653, h: 419 }, placements: ["header-band"] },
  // Line-art accents (single-color masks).
  { ...snap, type: "accent", id: "jcs-accent-topo", label: "Topographic lines", sourceFile: "accent-topo.png", sha1: "3d615764f1a005f719f0fd4edffc05edcaa1db9b", url: accentTopo, size: { w: 1237, h: 1237 }, placements: ACCENT },
  { ...snap, type: "accent", id: "jcs-accent-waves", label: "Flowing lines", sourceFile: "accent-waves.png", sha1: "5d368bc089bbc8bdd696eafa4586099edf53cdb8", url: accentWaves, size: { w: 1237, h: 1262 }, placements: ACCENT },
  { ...snap, type: "accent", id: "jcs-accent-arcs", label: "Nested arcs", sourceFile: "accent-arcs.png", sha1: "5ec31ff823f5ceb11350ceb4903f3aa00d2f9145", url: accentArcs, size: { w: 399, h: 799 }, placements: ACCENT },
  { ...snap, type: "accent", id: "jcs-accent-ribbon", label: "Line ribbon", sourceFile: "accent-ribbon.png", sha1: "fd31dee797dd7da16bc6ad13158255a0db259457", url: accentRibbon, size: { w: 617, h: 616 }, placements: ACCENT },
  { ...snap, type: "accent", id: "jcs-accent-dots", label: "Halftone dots", sourceFile: "accent-dots.png", sha1: "d11bd55dbb84963ebfc95e0505fa7681a05c9247", url: accentDots, size: { w: 617, h: 617 }, placements: ACCENT },
  { ...snap, type: "accent", id: "jcs-accent-stripes", label: "Bold stripes", sourceFile: "accent-stripes.png", sha1: "bed6f555cdeb7b89a8b87abbe656d5649ccf2c8c", url: accentStripes, size: { w: 1238, h: 700 }, placements: ACCENT },
];
